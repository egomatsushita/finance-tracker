...
from docs.user import user_create_example, user_endpoints, user_update_admin_example
from schemas.user import UserCreateSchema, UserReadSchema, UserUpdateAdminSchema
from services.user import UserService

ServiceDep = Annotated[UserService, get_service_dep(UserService)]

admin_user_router = APIRouter(
    prefix="/admin/users", tags=["admin-users"], dependencies=[RequireAdmin]
)
...
async def update_user(
    user_id: UUID,
    data: Annotated[UserUpdateAdminSchema, Body(examples=[user_update_admin_example])],
    service: ServiceDep,
) -> UserReadSchema:
    """
